...
export default function HomePage() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen page-container pb-24 fade-in" dir="rtl">
      ...
      <a 
        href="https://wa.me/9647739118013" 
        target="_blank" 
        rel="noopener noreferrer"
        className="fixed bottom-[75px] right-4 z-50 bg-[#25D366] hover:bg-[#1DA851] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg shadow-green-600/30 transition-transform active:scale-95 animate-in slide-in-from-bottom-5"
